...
namespace margelo::nitro::legendapps::chathistory {
  ...
  void HybridChatDocumentSpec::loadHybridMethods() {
    ...
    registerHybrids(this, [](Prototype& prototype) {
      ...
      prototype.registerHybridMethod("getRowKind", &HybridChatDocumentSpec::getRowKind);
      ...
      prototype.registerHybridMethod("getImageMetadata", &HybridChatDocumentSpec::getImageMetadata);
