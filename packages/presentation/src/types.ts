...
export type CustomTransition = { name?: string; source?: string; duration?: number; options?: Record<string, unknown> };
export type SlideTransition = string | CustomTransition | FocusTransition;
