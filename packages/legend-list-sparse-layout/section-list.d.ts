...
type SectionListLegendProps<ItemT, SectionT extends SectionBase<ItemT>> = Omit<LegendListProps<SectionListFlatItem<ItemT, SectionT>>, "data" | "dataSource" | "children" | "renderItem" | "keyExtractor" | "ItemSeparatorComponent" | "getItemType" | "getFixedItemSize" | "stickyHeaderIndices" | "numColumns" | "columnWrapperStyle" | "onViewableItemsChanged">;
