...
type KeyboardAwareLegendListProps<ItemT> = DistributiveOmit<AnimatedLegendListProps<ItemT>, "anchoredEndSpace" | "contentInsetEndAdjustment" | "renderScrollComponent"> & KeyboardChatScrollViewPropsUnique & {
...
declare const KeyboardAwareLegendList: <ItemT>(props: KeyboardAwareLegendListProps<ItemT> & React.RefAttributes<LegendListRef>) => React.ReactElement | null;
