...
namespace margelo::nitro::legenddesktop::diffparser {
  ...
  /**
   * A struct which can be represented as a JavaScript object (DiffSideBySideLineMetric).
   */
  struct DiffSideBySideLineMetric final {
  public:
  ...
  public:
    DiffSideBySideLineMetric() = default;
    explicit DiffSideBySideLineMetric(double index, std::string kind, double fileIndex, double hunkIndex, double sourceStart, double sourceEnd): index(index), kind(kind), fileIndex(fileIndex), hunkIndex(hunkIndex), sourceStart(sourceStart), sourceEnd(sourceEnd) {}

  public:
    friend bool operator==(const DiffSideBySideLineMetric& lhs, const DiffSideBySideLineMetric& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ DiffSideBySideLineMetric <> JS DiffSideBySideLineMetric (object)
  template <>
  struct JSIConverter<margelo::nitro::legenddesktop::diffparser::DiffSideBySideLineMetric> final {
    static inline margelo::nitro::legenddesktop::diffparser::DiffSideBySideLineMetric fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::legenddesktop::diffparser::DiffSideBySideLineMetric(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::legenddesktop::diffparser::DiffSideBySideLineMetric& arg) {
