...
namespace margelo::nitro::legenddesktop::diffparser {
   ...
   */
  struct DiffTokenizedRowRange final {
  public:
    double start     SWIFT_PRIVATE;
    double end     SWIFT_PRIVATE;

  public:
    DiffTokenizedRowRange() = default;
    explicit DiffTokenizedRowRange(double start, double end): start(start), end(end) {}
