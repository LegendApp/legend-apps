...
namespace margelo::nitro::legenddesktop::markdownparser {
  ...
  /**
   * A struct which can be represented as a JavaScript object (MarkdownBlockSnapshot).
   */
  struct MarkdownBlockSnapshot final {
  public:
  ...
  public:
    MarkdownBlockSnapshot() = default;
    explicit MarkdownBlockSnapshot(std::string id, double index, std::string type, double depth, std::string text, std::string markdown): id(id), index(index), type(type), depth(depth), text(text), markdown(markdown) {}

  public:
    friend bool operator==(const MarkdownBlockSnapshot& lhs, const MarkdownBlockSnapshot& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ MarkdownBlockSnapshot <> JS MarkdownBlockSnapshot (object)
  template <>
  struct JSIConverter<margelo::nitro::legenddesktop::markdownparser::MarkdownBlockSnapshot> final {
    static inline margelo::nitro::legenddesktop::markdownparser::MarkdownBlockSnapshot fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::legenddesktop::markdownparser::MarkdownBlockSnapshot(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::legenddesktop::markdownparser::MarkdownBlockSnapshot& arg) {
